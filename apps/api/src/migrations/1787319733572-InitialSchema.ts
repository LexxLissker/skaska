...
export class InitialSchema1787319733572 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "type" character varying NOT NULL DEFAULT 'Regular', "code" character varying NOT NULL, "state" character varying NOT NULL, "active" boolean NOT NULL DEFAULT true, "orderPlacedAt" TIMESTAMP, "couponCodes" text NOT NULL, "shippingAddress" text NOT NULL, "billingAddress" text NOT NULL, "currencyCode" character varying NOT NULL, "id" SERIAL NOT NULL, "aggregateOrderId" integer, "customerId" integer, "taxZoneId" integer, "subTotal" integer NOT NULL, "subTotalWithTax" integer NOT NULL, "shipping" integer NOT NULL DEFAULT '0', "shippingWithTax" integer NOT NULL DEFAULT '0', "customFieldsDeliveryzonecode" character varying(255), "customFieldsDeliveryrunid" character varying(255), "customFieldsDeliverydate" TIMESTAMP(6), "customFieldsDeliverywindow" character varying(255), "customFieldsDeliverycomment" text, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "order_line" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "quantity" integer NOT NULL, "orderPlacedQuantity" integer NOT NULL DEFAULT '0', "listPriceIncludesTax" boolean NOT NULL, "adjustments" text NOT NULL, "taxLines" text NOT NULL, "id" SERIAL NOT NULL, "sellerChannelId" integer, "shippingLineId" integer, "productVariantId" integer NOT NULL, "taxCategoryId" integer, "initialListPrice" integer, "listPrice" integer NOT NULL, "featuredAssetId" integer, "orderId" integer, "customFieldsDough" character varying(255) DEFAULT 'standard', "customFieldsFat" character varying(255) DEFAULT 'broth', "customFieldsColor" character varying(255) DEFAULT 'standard', "customFieldsTexture" character varying(255) DEFAULT 'fine', CONSTRAINT "PK_01a7c973d9f30479647e44f9892" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "delivery_zone" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "code" character varying NOT NULL, "name" character varying NOT NULL, "weekdays" text NOT NULL, "window" character varying NOT NULL, "cost" integer NOT NULL, "freeThreshold" integer NOT NULL, "deadlineDaysBefore" integer NOT NULL DEFAULT '1', "deadlineHour" integer NOT NULL DEFAULT '15', "runCapacity" integer NOT NULL DEFAULT '20', "enabled" boolean NOT NULL DEFAULT true, "id" SERIAL NOT NULL, CONSTRAINT "UQ_ece022156c1bed6bbcb6cbe138b" UNIQUE ("code"), CONSTRAINT "PK_8a390f981b91bfca80510b43511" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "delivery_run" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "zoneId" integer NOT NULL, "date" TIMESTAMP NOT NULL, "deadline" TIMESTAMP NOT NULL, "window" character varying NOT NULL, "capacity" integer NOT NULL, "bookedCount" integer NOT NULL DEFAULT '0', "cancelled" boolean NOT NULL DEFAULT false, "id" SERIAL NOT NULL, CONSTRAINT "UQ_a0f2a0630d1ad5db7b206a3bbca" UNIQUE ("zoneId", "date"), CONSTRAINT "PK_569ab83244a5ca26db6681f0eca" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_5480ea95c74d9954d9ad444830" ON "delivery_run" ("zoneId") `, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_81ce5db98d6c6539a7c04c0f75" ON "delivery_run" ("date") `, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "delivery_run" ADD CONSTRAINT "FK_5480ea95c74d9954d9ad4448306" FOREIGN KEY ("zoneId") REFERENCES "delivery_zone"("id") ON DELETE CASCADE ON UPDATE NO ACTION`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "delivery_run" DROP CONSTRAINT "FK_5480ea95c74d9954d9ad4448306"`, undefined);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_81ce5db98d6c6539a7c04c0f75"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_5480ea95c74d9954d9ad444830"`, undefined);
        await queryRunner.query(`DROP TABLE "delivery_run"`, undefined);
        await queryRunner.query(`DROP TABLE "delivery_zone"`, undefined);
