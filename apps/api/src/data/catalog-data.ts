...
/**
 * Уникальный текст каждой посадочной страницы каталога. Он одновременно
 * показывается покупателю и используется витриной как meta description,
 * поэтому описывает именно выбранный раздел, а не повторяет общий шаблон.
 */
export const SUBCATEGORY_DESCRIPTIONS: Record<string, Record<string, string>> = {
    pelmeni: {
        'Классика': 'Классические пельмени ручной лепки с мясными начинками: тонкое тесто, сочный фарш и насыщенный бульон внутри. Варятся прямо из морозильника за 7 минут.',
        'Птица': 'Пельмени ручной лепки с курицей и индейкой — более лёгкий вариант с нежной начинкой и тонким тестом. Подходят для быстрого семейного ужина.',
        'Рыба/Постное': 'Пельмени с рыбными и постными начинками для разнообразного домашнего меню. Лепим небольшими партиями и замораживаем сразу после лепки.',
    },
    vareniki: {
        'С картофелем': 'Домашние вареники с картофелем и жареным луком в тонком тесте. Сытный вариант для обеда или ужина, который можно сварить прямо из морозильника.',
        'С творогом': 'Вареники с нежной творожной начинкой и тонким домашним тестом. Подавайте со сметаной, сливочным маслом или ягодным соусом.',
        'С вишней': 'Сладкие вареники с сочной вишнёвой начинкой и тонким тестом. Быстрый десерт или завтрак со сливками, сметаной либо ягодным кули.',
    },
    manty: {
        'Говядина/баранина': 'Крупные манты с рубленой говядиной и бараниной, луком и ароматными специями. Готовятся на пару, сохраняя мясной сок внутри.',
        'Тыква': 'Манты с тыквой и луком — ароматная овощная начинка в тонком тесте. Подойдут для лёгкого домашнего обеда или ужина.',
        'Курица': 'Манты с курицей: нежная начинка, лук и сбалансированные специи в тонком тесте. Готовятся на пару прямо из замороженного состояния.',
    },
    hinkali: {
        'Классика': 'Классические хинкали с мясной начинкой, зеленью и бульоном внутри. Плотное тесто сохраняет форму и сочность во время варки.',
        'Сыр': 'Хинкали с сырной начинкой — мягкий сливочный вкус и упругое тесто. Самостоятельное блюдо, которое удобно приготовить прямо из морозильника.',
        'Грибы': 'Хинкали с грибами и ароматными специями в плотном тесте. Сочный вариант без мясной начинки для домашнего обеда или ужина.',
    },
    khanum: {
        'С мясом': 'Ханум с мясом — рулет из тонкого теста с рубленой начинкой, луком и специями. Сочный и сытный вариант семейного ужина, приготовленный на пару.',
        'С картофелем': 'Ханум с картофелем и луком: мягкая овощная начинка, специи и тонкое тесто. Готовится на пару и хорошо сочетается со сметанным соусом.',
        'Вегетарианские': 'Вегетарианский ханум с овощами, луком и специями в тонком тесте. Лёгкое, но сытное блюдо для приготовления на пару.',
    },
    lapsha: {
        'Домашняя': 'Домашняя пшеничная лапша с ровной текстурой и хорошей упругостью. Подходит для супов, бульонов и горячих блюд, быстро варится и держит форму.',
        'Гречневая': 'Гречневая лапша с выразительным ореховым вкусом. Подходит для горячих блюд с овощами, мясом или грибами и не теряет форму при варке.',
        'Рисовая': 'Рисовая лапша для супов, воков и лёгких горячих блюд. Быстро готовится и хорошо сочетается с овощами, птицей, морепродуктами и соусами.',
    },
    gastrolavka: {
        'Соусы': 'Соусы к пельменям, вареникам, мантам и другим домашним блюдам: от сметанно-чесночного до сацебели и ткемали. Добавьте к заказу готовую подачу.',
        'Масло и сливки': 'Топлёное и зелёное масло, а также густые сливки для подачи горячих блюд. Дополняют мясные, овощные и сладкие начинки.',
        'Бульоны': 'Концентрированные говяжьи, куриные и грибные бульоны для варки и подачи. Помогают быстро сделать вкус блюда насыщеннее.',
        'Топпинги': 'Хрустящий жареный лук, копчёные шкварки, ароматная соль и сладкие топпинги. Небольшие дополнения, которые меняют вкус и подачу блюда.',
    },
};

export function buildSubDescription(cat: CategoryDef, subName: string): string {
    return SUBCATEGORY_DESCRIPTIONS[cat.id]?.[subName] ?? cat.desc;
}
