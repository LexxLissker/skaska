...
/**
 * Независимая витрина над каталогом. Фотографии временно берутся из уже
 * управляемых в Vendure коллекций и наборов; тексты позже можно перенести в CMS.
 */
export const HERO_SLIDES = [
    {
        id: 'handmade',
        eyebrow: 'Ручная лепка · небольшие партии',
        title: 'Домашняя еда, которую легко приготовить',
        description: 'Лепим вручную, замораживаем в день производства и готовим без предварительной разморозки.',
        controlTitle: 'Ручная лепка',
        controlText: 'Готовим небольшими партиями',
    },
    {
        id: 'bundles',
        eyebrow: 'Наборы для дома',
        title: 'Несколько любимых блюд в одном заказе',
        description: 'Дегустационные и семейные наборы помогают попробовать больше вкусов и выгоднее наполнить морозилку.',
        controlTitle: 'Наборы',
        controlText: 'Для семьи, пары и знакомства',
    },
    {
        id: 'delivery',
        eyebrow: 'Доставка по расписанию',
        title: 'Привезём холодными и точно ко времени',
        description: 'Собираем заказы заранее и доставляем в термосумках с хладоэлементами по выбранным дням.',
        controlTitle: 'Доставка',
        controlText: 'Бережно и без разморозки',
    },
] as const;
